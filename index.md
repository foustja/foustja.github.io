...
<html>
  ...
  <nav style="display: flex; gap: 20px;">
    <a href="index.html" aria-current="page">
      <h2><span style="border: 2px solid black; padding: 5px; display: inline-block;">
      Home
      </span></h2>
    </a>
  ...
  <main>
    ...
    <p>
     ...
     <a href="https://medium.com/@koma.tebe/tiny-code-dbf26d84fe38">here</a>.)
     I used it to learn more about p5js, つぶやきProcessing, and web graphics.<br>
     ...
     command: ffmpeg -i xxxx.mp4 xxxx.gif. Simple enough.<br>
    ...
    <p>Luxaterna is a light sculpture constructed from WS2822S LEDs embedded
      ...
      Arduino/C++ and FastLED allow cycling through a series of patterns and colors.
    </p>

    <a href="Luxaeterna2.mp4"
      title="2 min. Video">Pre-recorded (Full Screen)</a><br>

    <a href="https://www.youtube.com/embed/live_stream?channel=UCH1IeN5ZQYLfa2T7RVm72mA"
      title="Youtube Livestream">Livestream (when available)</a>
  ...
  <footer>
    ...
    <p>
      ...
      <a href="https://pulsar-edit.dev/">Pulsar</a> is virtually identical
